/**
 * GORFO ALERT: classe copiada diretamente do repo do Xamarin.Forms.
 * 
 * Ué, mas por quê?
 * Porque o MediaElementRenderer é sealed, então, não consigo herdar e fazer
 * a sobrecarga apenas no Dispose.
 * 
 * Precisei fazer uma alteração no dispose pois no iOS sempre travava quando 
 * alterava as abas no app. A solução que encontrei está nesse 
 * link https://forums.xamarin.com/discussion/181623/media-element-crash-when-navigating-away-from-page-on-ios
 */
using AVFoundation;
using AVKit;
using CoreGraphics;
...
{
	public sealed class CustomMediaElementRenderer : ViewRenderer<MediaElement, UIView>
	{
		...
		public CustomMediaElementRenderer()
		{
